...
from eutester.euca.cloud_admin import EucaResponseException, EucaNotFoundException
from eutester.euca.cloud_admin.cluster_controller import (
    EucaClusterControllerService,
    SHOW_CLUSTER_CONTROLLER_SERVICES
)
from eutester.euca.cloud_admin.cloud_controller import EucaCloudControllerService
from eutester.euca.cloud_admin.storage_controller import EucaStorageControllerService
from eutester.euca.cloud_admin.object_storage_gateway import EucaObjectStorageGatewayService
from eutester.euca.cloud_admin.nodecontroller import EucaNodeService, SHOW_NODES
from eutester.euca.cloud_admin.walrus import EucaWalrusBackendService
from eutester.euca.cloud_admin.arbitrator import EucaArbitratorService
from eutester.euca.cloud_admin.vmware_broker import EucaVMwareBrokerService
from eutester.euca.cloud_admin.services import (
    EucaService,
    EucaServiceList,
...
from eutester.euca.cloud_admin.eucaproperty import (
    EucaProperty,
    SHOW_PROPERTIES,
...
\       """
    ...
    def show_walrus_backends(self, walruses=None, print_table=True):
        return SHOW_COMPONENTS(walruses, self.get_all_walrus_backend_services, print_table)
